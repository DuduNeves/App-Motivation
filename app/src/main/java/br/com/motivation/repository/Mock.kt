package br.com.motivation.repository
...
class Mock {
    ...
    private val ALL = MotivationConstant.PHRASEFILTER.ALL
    private val MORNING = MotivationConstant.PHRASEFILTER.MORNING
    private val HAPPY = MotivationConstant.PHRASEFILTER.HAPPY
